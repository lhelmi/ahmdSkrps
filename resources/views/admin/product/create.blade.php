                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="form-control @error('kode-number') is-invalid @enderror" name="kode-number"
                                        id="kode-number" placeholder="" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{ old('kode-number') }}" maxlength="3">
                                    </div>
                                </div>
                            </div>
                        </div>
