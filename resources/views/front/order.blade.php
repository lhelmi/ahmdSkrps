...
<section class="jumbotron text-center">
    <div class="container">
        <div class="content-1">
            <h1 class="jumbotron-heading">Hubungi</h1>
            <img src="{{ asset('front/images/Wa-Icon.png') }}" style="height: 45px; width: 48px;" data-holder-rendered="true" >
            <strong class="text-gray-dark">081219450221</strong>
            <br>
            <img src="{{ asset('front/images/Wa-Icon.png') }}" style="height: 45px; width: 48px;" data-holder-rendered="true" >
            <strong class="text-gray-dark">085293444755</strong>
            <br>
            <img src="{{ asset('front/images/Wa-Icon.png') }}" style="height: 45px; width: 48px;" data-holder-rendered="true" >
        ...
        <div class="content-2">
            ...
            <br>
            <br>
            <img src="{{ asset('front/images/Facebook-Icon.png') }}" style="height: 45px; width: 48px;" data-holder-rendered="true" >
            <strong class="text-gray-dark">@qwewrttrt</strong>
            <br>
            <br>
            <br>
