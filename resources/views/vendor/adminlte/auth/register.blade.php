...
@section('auth_body')
    <form action="{{ $register_url }}" method="post">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="input-group mb-3">
                    <input type="text" name="birth_place" class="form-control @error('birth_place') is-invalid @enderror"
                            value="{{ old('birth_place') }}" placeholder="Tempat Lahir" autofocus>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="input-group mb-3">
                    <input type="date" name="birth_date" class="form-control @error('birth_date') is-invalid @enderror"
                            value="{{ old('birth_date') }}" placeholder="Tempat Lahir" autofocus>
        ...
        {{-- address field --}}
        <div class="input-group mb-3">
            <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address" cols="30" rows="2"
            placeholder="Alamat Lengkap" autofocus >{{ old('address') }}</textarea>
            <div class="input-group-append">
                <div class="input-group-text">
